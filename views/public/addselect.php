					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="index.php?r=login/login">控制台</a>
							</li>

							<li>
								<a href="#">公众号管理</a>
							</li>
							<li class="active">展示添加公众号</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="index.php?r=public/addall" method="post" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required="required" id="form-field-2" placeholder="微信公众平台" class="col-xs-10 col-sm-5" readonly="true" />
                                        </div>
                                    </div>
                                    <div class="form-group">
